...
Answer the following questions. (If you **do not** show your calculations, you will be given **no credit**.)

(a) What is .mono[YYZ]'s marginal propensity to consume? (*2 points*)

(b) What is .mono[YYZ]'s marginal propensity to save? (*2 points*)

(c) Show the expression (equation) for .mono[YYZ]'s aggregate expenditures function. (*2 points*)

(d) What is the equilibrium level of income for .mono[YYZ]? (*2 points*)

(e) Now, suppose that the level of planned investment increases to *I' = $ 200* in the following year. What is the new equilibrium level of income for .mono[YYZ]? (*2 points*)

(f) Given your answers to  parts (d) and (e), what is the size of .mono[YYZ]'s multiplier? To get full credit, you must show its value in *two* different ways. (*2 points*)
